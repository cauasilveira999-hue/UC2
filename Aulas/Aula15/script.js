...
let animais = Number (prompt('Quantos animais de estimação você tem?'))
...
if(animais <= 0){
   ...
   let digiteAnimais = prompt("Digite os nomes de seus animais")
   digiteAnimais = [" "]
for(let i = 0; i < animais; i++)
digiteAnimais += animais
}
console.log(digiteAnimais)